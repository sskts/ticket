...
import { MemberGuardService, PaymentCardGuardService } from '../../guards';
...
const routes: Routes = [
    {
        path: '',
        children: [{ path: 'select', component: AuthSelectComponent }],
    },
    {
        path: '',
            ...
            { path: 'signout', component: AuthSignoutComponent },
            {
                ...
                children: [
                    ...
                    { path: 'terms', component: AuthRegisterTermsComponent },
                    {
                        ...
                        component: AuthRegisterCreditComponent,
                    },
                    {
                        path: 'membership',
                        canActivate: [
                        ...
                        component: AuthRegisterProgramMembershipComponent,
                    },
                ],
            },
        ],
    },
    {
        ...
        children: [{ path: 'logout', component: AuthLogoutComponent }],
    },
];
