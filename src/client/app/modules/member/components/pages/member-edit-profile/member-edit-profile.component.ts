...
export class MemberEditProfileComponent implements OnInit {
    ...
    private createForm() {
            ...
            telephone: {
                ...
                validators: [
                    ...
                    (control: AbstractControl): ValidationErrors | null => {
                        ...
                        if (field !== null) {
                            const parsedNumber = libphonenumber.parse(
                                field.value,
                                'JP'
                            );
        ...
        profile.givenName.value =
            contact.givenName === undefined ? '' : contact.givenName;
        profile.familyName.value =
            contact.familyName === undefined ? '' : contact.familyName;
        ...
        profile.theaterCode.value =
            ...
            getConfig().closeTheaters.find((t) => t === theaterCode) !==
                undefined
                ? ''
                : theaterCode;
        ...
        return this.formBuilder.group({
            ...
            theaterCode: [
                profile.theaterCode.value,
                profile.theaterCode.validators,
            ],
        });
    }
