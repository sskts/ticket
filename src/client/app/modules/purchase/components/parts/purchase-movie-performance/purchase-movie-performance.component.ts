...
@Component({
    selector: 'app-purchase-movie-performance',
    templateUrl: './purchase-movie-performance.component.html',
    styleUrls: ['./purchase-movie-performance.component.scss'],
})
export class PurchaseMoviePerformanceComponent implements OnInit {
