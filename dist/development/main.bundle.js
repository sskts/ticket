...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__component_purchase_chronological_order_chronological_order_component__ = __webpack_require__("../../../../../src/app/component/purchase/chronological-order/chronological-order.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__component_purchase_film_order_performance_film_order_performance_component__ = __webpack_require__("../../../../../src/app/component/purchase/film-order-performance/film-order-performance.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__service_purchase_purchase_service__ = __webpack_require__("../../../../../src/app/service/purchase/purchase.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_20__component_purchase_chronological_order_chronological_order_component__["a" /* ChronologicalOrderComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_21__component_purchase_film_order_performance_film_order_performance_component__["a" /* FilmOrderPerformanceComponent */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_33__service_purchase_purchase_service__["a" /* PurchaseService */],
...
var ScheduleComponent = /** @class */ (function () {
    ...
    ScheduleComponent.prototype.createDate = function () {
        ...
        for (var i = 0; i < limit; i += 1) {
            ...
            var formatDate = date.format('YYYY年MM月DD日');
            results.push({
...
var ScreeningEventsModel = /** @class */ (function () {
    ...
    ScreeningEventsModel.prototype.getEventByChronologicalOrder = function () {
        var _this = this;
        return this.individualScreeningEvents.filter(function (performance) {
            // 販売可能時間判定
            return _this.isSalse(performance.startDate);
        });
    };
    /**
     * 作品別へ変換
    ...
    ScreeningEventsModel.prototype.getEventByFilmOrder = function () {
        ...
        this.individualScreeningEvents.forEach(function (performance) {
            // 販売可能時間判定
            if (!_this.isSalse(performance.startDate)) {
                return;
            }
     ...
     * @returns {boolean}
     */
    ScreeningEventsModel.prototype.isSalse = function (startDate) {
        return (__WEBPACK_IMPORTED_MODULE_0_moment__().unix() < __WEBPACK_IMPORTED_MODULE_0_moment__(startDate).subtract(END_TIME, 'minutes').unix());
    };
