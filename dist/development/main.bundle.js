        ...
        reservations.forEach(function (reservation) {
            ...
            var data = JSON.stringify({
                ...
                value: {
                    ...
                    title: '上映時間が近づいています',
                    text: __WEBPACK_IMPORTED_MODULE_1_moment__(reservationFor.startDate).format('YYYY/MM/DD HH:mm') + " " + reservationFor.workPerformed.name,
                    trigger: { at: __WEBPACK_IMPORTED_MODULE_1_moment__(reservationFor.startDate).subtract(30, 'minutes').toISOString() }
                }
            });
            window.parent.postMessage(data, '*');
        });
