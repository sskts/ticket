...
var AuthRegisterProgramMembershipComponent = /** @class */ (function () {
    function AuthRegisterProgramMembershipComponent(router, formBuilder, cinerino, member, maintenance) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.cinerino = cinerino;
        this.member = member;
