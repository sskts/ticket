...
var MemberEditProfileComponent = /** @class */ (function () {
    function MemberEditProfileComponent(formBuilder, elementRef, router, user, maintenance, cinerino) {
        this.formBuilder = formBuilder;
        this.elementRef = elementRef;
        this.router = router;
        this.user = user;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.cinerino.seller.search({ typeOfs: [_cinerino_api_javascript_client__WEBPACK_IMPORTED_MODULE_3__["factory"].organizationType.MovieTheater] })];
                    case 2:
                        result = _a.sent();
